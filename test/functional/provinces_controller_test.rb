...
class ProvincesControllerTest < ActionController::TestCase
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post :create, province: { latitude: @province.latitude, longitude: @province.longitude, name: @province.name }
    end
  ...
  test "should update province" do
    put :update, id: @province, province: { latitude: @province.latitude, longitude: @province.longitude, name: @province.name }
    assert_redirected_to province_path(assigns(:province))
  end
