...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { latitude: @district.latitude, longitude: @district.longitude, name: @district.name, province_id: @district.province_id }
    end
  ...
  test "should update district" do
    put :update, id: @district, district: { latitude: @district.latitude, longitude: @district.longitude, name: @district.name, province_id: @district.province_id }
    assert_redirected_to district_path(assigns(:district))
  end
